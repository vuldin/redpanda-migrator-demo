...
- **Schema IDs** will differ between source and target (this is expected)
- **Replication factors** preserved from source (or can be overridden)
...
- Partition counts
- Replication factors
- Cleanup policies (`compact`, `compact,delete`, `delete`)
- Other topic-level configurations
...
This will confirm that cleanup policies match between source and target clusters.
